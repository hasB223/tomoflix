# TomoFlix — Instructions for Codex
...
## Working agreement
- This project is also being developed via Claude Code and via chat
  sessions with Claude (claude.ai). All three should treat `context.md`,
